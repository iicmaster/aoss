<div id="contact_form" class="column grid_8">
	<h2><?php echo image_asset('theme/'.$member_theme['name'].'/'.$member_theme['color'].'/bg_banner_fold_right.png', 'site', array('alt'=>'ribbon', 'width'=>'11', 'height'=>'41', 'class'=>'right_ribbon')); ?>รับตัวอย่างผลิตภัณฑ์ฟรี</h2>
